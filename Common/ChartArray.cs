...
namespace CudaTools
{
    ...
    public class ChartArray : IDisposable
    {
        ...
        //    float xmin, float xmax, float ymin, float ymax, int maxNumDataPoints, int numTraces, CudaChartArray** pp_chartArray)
        static extern bool ChartArray_Init(int chartRows, int chartCols, int chartArrayWidth, int chartArrayHeight, int margin, int padding,
                                           ...
                                           float xmin, float xmax, float ymin, float ymax, int maxNumPoints, int numTraces, out IntPtr chartArray);
        ...
        public bool Init(int chartRows, int chartCols, int chartArrayWidth, int chartArrayHeight, int margin, int padding,
                        ...
                        float xmin, float xmax, float ymin, float ymax, int maxNumPoints, int numTraces)
        {
        ...
        // void SetInitialRanges(CudaChartArray* pChartArray, int traceNum, float xmin, float xmax, float ymin, float ymax)
        static extern void ChartArray_SetInitialRanges(IntPtr pChartArray, int traceNum, float xmin, float xmax, float ymin, float ymax);


        public void SetIntialRanges(int traceNum, float xmin, float xmax, float ymin, float ymax)
        {
            try
            {
                ChartArray_SetInitialRanges(chartArray, traceNum, xmin, xmax, ymin, ymax);
            }
            catch (Exception ex)
            {
        ...
        // void AppendData(CudaChartArray* pChartArray, float* xArray, float* yArray, int numPoints, int traceNum)
        ...
        public void AppendData(float[] xVals, float[] yVals, int traceNum)
        {
            try
            {
        ...
        // void* GetRangePtr(CudaChartArray* pChartArray, int traceNum)
        static extern IntPtr ChartArray_GetRangePtr(IntPtr pChartArray, int traceNum);

        public void GetRanges(ref float[] range, int traceNum)
        {
            try
            {
                IntPtr rangePtr = ChartArray_GetRangePtr(chartArray, traceNum);
